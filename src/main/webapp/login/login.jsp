        ...
        $(function () {
            $("#loginButtonId").click(function () {
                $.ajax({
                    ...
                    type:"POST",
                    data:$("#loginForm").serialize(), //序列化接收form表单中的参数
                    dataType:"JSON",
                    success:function (data) {
                        if("codeError"==(data.message)){
                            $("#message").text("您的验证码有误！！！").css("color","red")
                        }
                        if("usernameError"==(data.message)){
                            $("#message").text("请核对您的用户名或密码！！！").css("color","green")
                        }
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top" style="width: 450px">
                        <div class="form-top-left">
                            ...
                            <p id="message">Enter your username and password to log on:</p>
                        </div>
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 48px;border-radius: 5px" class="captchaImage"
                                     src="${pageContext.request.contextPath}/code/getCode">
                                <input placeholder="请输入验证码..." style="width: 272px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
